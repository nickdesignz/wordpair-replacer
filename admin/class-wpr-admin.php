		...
		wp_localize_script(
			...
			array(
				...
				'i18n'    => array(
					...
					'editStyling'         => wpr_t( 'Styling bearbeiten' ),
					'active'              => wpr_t( 'Aktiv' ),
					'inactive'            => wpr_t( 'Inaktiv' ),
					'favorite'            => wpr_t( 'Favorit' ),
					'favorites'           => wpr_t( 'Favoriten' ),
					'deleteLabel'         => wpr_t( 'Löschen' ),
					'filterAll'           => wpr_t( 'Alle' ),
					'entriesSuffix'       => wpr_t( 'Einträge' ),
					'duplicateLabel'      => wpr_t( 'Duplizieren' ),
					'exportLabel'         => wpr_t( 'Exportieren' ),
					'editWord'            => wpr_t( 'Wort bearbeiten' ),
					'importNoData'        => wpr_t( 'Keine Importdaten gefunden.' ),
					'importInvalidJson'   => wpr_t( 'JSON konnte nicht gelesen werden.' ),
					'pairDuplicated'      => wpr_t( 'Wortpaar dupliziert.' ),
					'confirmDeletePreset' => wpr_t( 'Delete this preset?' ),
				),
			)
		);
	}
